...
public:
    ...
    /// </summary>
    void Initialize(KamataEngine::Camera* camera, int32_t lineCount = 80);
...
private:
    struct LineParticle {
        KamataEngine::WorldTransform* worldTransform_ = nullptr;  // ポインタで管理
        float speed_ = 0.0f;                                      // カメラに向かって流れる速度
